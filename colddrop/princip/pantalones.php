<?php
// ========================================================
// CATÁLOGO DE PANTALONES (PANTALONES.PHP)
// ========================================================
...
// Consultar Pantalones
$sql = "SELECT * FROM productos WHERE Tipo = 'Pantalón'";
...
<head>
    ...
    <title>Pantalones - ColdDrop</title>
...
<body>
    ...
    <section>
        <h1 id="nombrecollect">Nuestros Pantalones</h1>
        ...
        <div id="imagenes">
            ...
            if ($resultado && $resultado->num_rows > 0) {
                while ($fila = $resultado->fetch_assoc()) {
                    ...
                    ?>
                    <div class="card">
                        <img class="imagen" src="../imagenes/<?php echo htmlspecialchars($img); ?>" alt="Pantalón">
                        <div class="texto">
                ...
                echo "<p style='text-align:center;'>No hay pantalones disponibles por el momento.</p>";
            }
            ?>
        </div>
    </section>
    ...
    <section style="text-align: center; margin: 40px 0;">
        <h2 style="font-size: 24px; color: #555;">Estilo urbano y cómodo - Cold Wave</h2>
    </section>
